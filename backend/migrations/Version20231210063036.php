 ...
 */
final class Version20231210063036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projet (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, titre_actvite VARCHAR(255) NOT NULL, desc_activite VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, statut_projet VARCHAR(255) NOT NULL, duree_projet VARCHAR(255) NOT NULL, INDEX IDX_50159CA9FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
